...
HD_PWD='C:/Users/augus/Documents/Fundacion Fulgor/Digital design Verilog RTL Course/Designs/n_adder/n_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log n_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source n_adder.tcl
