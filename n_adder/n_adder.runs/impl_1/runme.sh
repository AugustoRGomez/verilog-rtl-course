...
HD_PWD='C:/Users/augus/Documents/Fundacion Fulgor/Digital design Verilog RTL Course/Designs/n_adder/n_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log n_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source n_adder.tcl -notrace
